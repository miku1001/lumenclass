...
const ROOM_DATA = {
  ...
  r101: {
    ...
    kpis: [
      ...
      { cls: 'k2', icon: 'users', trend: 'OCCUPIED',  trendCls: 'up', val: '2',   unit: 'present', lab: 'Occupancy (PIR motion)' },
      { cls: 'k3', icon: 'alert', trend: '0 active',  trendCls: 'up', val: '0',   unit: 'today',   lab: 'Alerts & events' },
    ],
    zones: [
      { id: 'zA', name: 'Front — Left Corner',  meta: 'Motion detected · auto', on: true,  dim: 65, tag: 'AUTO' },
      { id: 'zB', name: 'Front — Right Corner', meta: 'Motion detected · auto', on: true,  dim: 65, tag: 'AUTO' },
      { id: 'zH', name: 'Back — Right Corner',  meta: 'No motion · standby',    on: false, dim: 0,  tag: 'AUTO' },
      { id: 'zC', name: 'Back — Left Corner',   meta: 'No motion · standby',    on: false, dim: 0,  tag: 'AUTO' },
    ],
    sensorLux: '390',
    sensorDecision: 'Dimming → 65%',
    sensorDecisionNote: 'Moderate ambient light · auto-level active',
  },
  r305: {
    title: 'Room 305 — Lighting Overview',
    desc: 'Lab wing with precision dimming for sensitive equipment',
    kpis: [
      { cls: 'k1', icon: 'sun',   trend: 'MODERATE', trendCls: 'up', val: '610', unit: 'lux',     lab: 'Ambient brightness (LDR)' },
      { cls: 'k2', icon: 'users', trend: 'OCCUPIED',  trendCls: 'up', val: '3',   unit: 'present', lab: 'Occupancy (PIR motion)' },
      { cls: 'k3', icon: 'alert', trend: '0 active',  trendCls: 'up', val: '0',   unit: 'today',   lab: 'Alerts & events' },
    ],
    zones: [
      { id: 'zA', name: 'Front — Left Corner',  meta: 'Motion detected · auto', on: true,  dim: 40, tag: 'AUTO' },
      { id: 'zB', name: 'Front — Right Corner', meta: 'Motion detected · auto', on: true,  dim: 40, tag: 'AUTO' },
      { id: 'zH', name: 'Back — Right Corner',  meta: 'Motion detected · auto', on: true,  dim: 40, tag: 'AUTO' },
      { id: 'zC', name: 'Back — Left Corner',   meta: 'No motion · standby',    on: false, dim: 0,  tag: 'AUTO' },
    ],
    sensorLux: '610',
    sensorDecision: 'Dimming → 40%',
    sensorDecisionNote: 'Moderate daylight · precision dimming active',
  },
  r212: {
    ...
    kpis: [
      ...
      { cls: 'k2', icon: 'users', trend: 'OCCUPIED',  trendCls: 'up', val: '4',   unit: 'present', lab: 'Occupancy (PIR motion)' },
      { cls: 'k3', icon: 'alert', trend: '0 active',  trendCls: 'up', val: '0',   unit: 'today',   lab: 'Alerts & events' },
    ],
    zones: [
      { id: 'zA', name: 'Front — Left Corner',  meta: 'Motion detected · auto', on: true, dim: 12, tag: 'AUTO' },
      { id: 'zB', name: 'Front — Right Corner', meta: 'Motion detected · auto', on: true, dim: 12, tag: 'AUTO' },
      { id: 'zH', name: 'Back — Right Corner',  meta: 'Motion detected · auto', on: true, dim: 12, tag: 'AUTO' },
      { id: 'zC', name: 'Back — Left Corner',   meta: 'Motion detected · auto', on: true, dim: 12, tag: 'AUTO' },
    ],
    sensorLux: '920',
    sensorDecision: 'Dimming → 12%',
    sensorDecisionNote: 'Peak afternoon sun — maximum saving',
  },
  r408: {
    ...
    kpis: [
      ...
      { cls: 'k2', icon: 'users', trend: 'LOW OCC',   trendCls: 'dn', val: '2',   unit: 'present', lab: 'Occupancy (PIR motion)' },
      { cls: 'k3', icon: 'alert', trend: '0 active',  trendCls: 'up', val: '0',   unit: 'today',   lab: 'Alerts & events' },
    ],
    zones: [
      { id: 'zA', name: 'Front — Left Corner',  meta: 'Motion detected · auto', on: true,  dim: 55, tag: 'AUTO' },
      { id: 'zB', name: 'Front — Right Corner', meta: 'No motion · standby',    on: false, dim: 0,  tag: 'AUTO' },
      { id: 'zH', name: 'Back — Right Corner',  meta: 'No motion · standby',    on: false, dim: 0,  tag: 'AUTO' },
      { id: 'zC', name: 'Back — Left Corner',   meta: 'Motion detected · auto', on: true,  dim: 55, tag: 'AUTO' },
    ],
    sensorLux: '540',
    sensorDecision: 'Dimming → 55%',
    sensorDecisionNote: 'Moderate ambient light · skylight assist active',
  },
}
                ...
                <div className="kpis items-center justify-center min-h-screen">
                  {displayData.kpis.map((k, i) => (
                    <div key={i} className={`kpi ${k.cls}`}>
                      ...
                      <div className={`trend ${k.trendCls}`}>{k.icon === 'alert' ? todayLabel : k.trend}</div>
